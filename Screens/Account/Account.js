...
import ProfileOptionsAuth from '../../routes/profileOptionsAuth';
...
const header = {
  ...
  headerRight: () => <ProfileOptionsAuth />,
  headerTitle: 'review',
};
  ...
  return (
    <accountStack.Navigator>
      <accountStack.Screen
        ...
        // options={header}
      />
      <accountStack.Screen name="Settings" component={SettingsHome} />
      <accountStack.Screen name="Profile" component={ProfileHome} />
      <accountStack.Screen name="Subscription" component={SubcriptionsHome} />
    </accountStack.Navigator>
  );
};

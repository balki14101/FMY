...
export default function Login({navigation}) {
  ...
  useEffect((async) => {
    (async () => {
      ...
      var isThirdStepCompletd = await AsyncStorage.getItem(
        '@third_step_completed',
      );
      var isSecondStepCompletd = await AsyncStorage.getItem(
        '@second_step_completed',
      );
      var isFirstStepCompletd = await AsyncStorage.getItem(
  ...
  const handleLogin = async () => {
    ...
    if (fieldsEmpty) {
      ...
      fetch(
        'https://lawyerback.trikaradev.xyz/api/lawyer-login',
        requestOptions,
      )
  ...
  const setUserData = async (json) => {
    ...
    if (stringJSON.includes('error')) {
      ...
      if (json.UserInfo.user.lawyer.firm_name !== null) {
        await AsyncStorage.setItem(
          '@firm_name',
          json.UserInfo.user.lawyer.firm_name,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.latitude !== null) {
        await AsyncStorage.setItem(
          '@latitude',
          json.UserInfo.user.lawyer.latitude,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.longitude !== null) {
        await AsyncStorage.setItem(
          '@longitude',
          json.UserInfo.user.lawyer.longitude,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.experience_years !== null) {
        await AsyncStorage.setItem(
          '@experience_years',
          json.UserInfo.user.lawyer.experience_years,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.is_verified !== null) {
        await AsyncStorage.setItem(
          '@is_verified',
          '' + json.UserInfo.user.lawyer.is_verified,
        );
      }

      if (json.UserInfo.user.lawyer.practicing_in_courts !== null) {
        await AsyncStorage.setItem(
          '@practicing_in_courts',
          json.UserInfo.user.lawyer.practicing_in_courts,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.lawyer_type !== null) {
        await AsyncStorage.setItem(
          '@lawyer_type',
          json.UserInfo.user.lawyer.lawyer_type,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.num_of_cases_won !== null) {
        await AsyncStorage.setItem(
          '@num_of_cases_won',
          json.UserInfo.user.lawyer.num_of_cases_won,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.description !== null) {
        await AsyncStorage.setItem(
          '@description',
          json.UserInfo.user.lawyer.description,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.full_address !== null) {
        await AsyncStorage.setItem(
          '@full_address',
          json.UserInfo.user.lawyer.full_address,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.pincode !== null) {
        await AsyncStorage.setItem(
          '@pincode',
          json.UserInfo.user.lawyer.pincode,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.is_civil !== null) {
        await AsyncStorage.setItem(
          '@is_civil',
          '' + json.UserInfo.user.lawyer.is_civil,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.is_criminal !== null) {
        await AsyncStorage.setItem(
          '@is_criminal',
          '' + json.UserInfo.user.lawyer.is_criminal,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.profile_picture_path !== null) {
        await AsyncStorage.setItem(
          ...
          json.UserInfo.user.lawyer.profile_picture_path,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.is_office_address !== null) {
        await AsyncStorage.setItem(
          '@is_office_address',
          '' + json.UserInfo.user.lawyer.is_office_address,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.contact_email !== null) {
        await AsyncStorage.setItem(
          '@contact_email',
          json.UserInfo.user.lawyer.contact_email,
        );
      }
      ...
      if (json.UserInfo.user.lawyer.private_phone_number !== null) {
        await AsyncStorage.setItem(
          ...
          json.UserInfo.user.lawyer.private_phone_number,
        );
      }
          ...
          <View style={{paddingStart: 20, paddingEnd: 20}}>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Text
                  style={[styles.forgot, {color: '#2D59A6', paddingLeft: 5}]}>
                  Reset Password
                </Text>
              </TouchableOpacity>
            </View>

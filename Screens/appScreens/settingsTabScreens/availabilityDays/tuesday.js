...
export default function Tuesday(props) {
  ...
  const [breakEndHourSun, setBreakEndHourSun] = useState("0")
	...
	const setConfirm = (lawyerDay) => {
	 ...
	 const handleTuesdayChange = async(index, value) => {
    ...
    fetch('https://lawyerback.trikara.com/api/lawyer-set-day-status?day=tue&val=' + valueToSet, {
      method: "POST",
      headers: {
   ...
   // Handle start time change (tuesday)
  const handleStartHourChangeTuesday = async(index, value) => {
  	
  	if(getValueFromName(value) == "0"){
  		  var newVal = getValueFromName(value);
    	setStartHourTue(newVal);
    	...
    	fetch('https://lawyerback.trikara.com/api/lawyer-set-start-time-tue?start_time=' + newVal, requestOptions)
      	.then((response) => response.json())
      	.then((json) => returnStartTimeTuesday(json.lawyer))
      	.catch((error) => console.error('ss'))
      	.finally(() => setLoading(false));
  	}else{


    if((parseInt(getValueFromName(value))>parseInt(endHourTue))){
  ...
  const returnStartTimeTuesday = (lawyer) => {
    setStartHourTue((lawyer.start_time_hour_tuesday).toString());
  }
  
  
  // Handle end time change (tuesday)
  const handleEndHourChangeTuesday = async(index, value) => {
  	
  	if(getValueFromName(value) == "0"){
  		 var newVal = getValueFromName(value);
    	setEndHourTue(newVal);
    	...
    	fetch('https://lawyerback.trikara.com/api/lawyer-set-end-time-tue?end_time=' + newVal, requestOptions)
      	.then((response) => response.json())
      	.then((json) => returnEndTimeTuesday(json.lawyer))
      	.catch((error) => console.error('ss'))
      	.finally(() => setLoading(false));
   }else{

    if((parseInt(getValueFromName(value))<parseInt(startHourTue))){
  ...
  const returnEndTimeTuesday = (lawyer) => {
    setEndHourTue((lawyer.end_time_hour_tuesday).toString());
  }
  
  
  // Handle break time start of day (tuesday)    
  const handleBreakStartHourChangeTuesday = async(index, value) => {
  	
  	if(value == "0"){
  		var newVal = getValueFromName(value);
    	setBreakStartHourTue(newVal);
    	...
    	fetch('https://lawyerback.trikara.com/api/lawyer-set-break-start-time-tue?start_time=' + newVal, requestOptions)
      	.then((response) => response.json())
      	.then((json) => returnStartTime1Tuesday(json.lawyer))
      	.catch((error) => console.error('ss'))
      	.finally(() => setLoading(false));
  		}else{


    if((parseInt(getValueFromName(value))<parseInt(startHourTue)) || (parseInt(getValueFromName(value))>parseInt(endHourTue))){
       //message.error('Break time has to be within working hours');
       Toast.show({
                type: 'error',
                text1: 'Break time has to be within working hours',
            });
    }else if((parseInt(getValueFromName(value))>parseInt(breakEndHourTue)) && (getValueFromName(value)!=="0")&& (breakEndHourTue!=='0')){
  ...
  const returnStartTime1Tuesday = (lawyer) => {
    setBreakStartHourTue((lawyer.break_start_hour_tuesday).toString());
  }


// Handle break end time of day (tuesday)
  const handleBreakEndHourChangeTuesday = async(index, value) => {
    //(event) {
    	
    	if(getValueFromName(value) == "0"){
    		 var newVal = getValueFromName(value);
    	setBreakEndHourTue(newVal);
    	...
    	fetch('https://lawyerback.trikara.com/api/lawyer-set-break-end-time-tue?end_time=' + newVal, requestOptions)
      	.then((response) => response.json())
      	.then((json) => returnEndTime1Tuesday(json.lawyer))
      	.catch((error) => console.error('ss'))
      	.finally(() => setLoading(false));
    	}else{
    ...
    }else if((parseInt(getValueFromName(value))<parseInt(breakStartHourTue)) && (getValueFromName(value)!=="0")){
  ...
  const returnEndTime1Tuesday = (lawyer) => {
        ...
        <View style={{ marginTop: 20 }}>
            ...
            <View style={{ paddingTop: 10 }}>
                ...
                <View style={{ flexDirection: 'row', paddingTop: 10, justifyContent: 'space-between' }}>
                    <ModalDropdown
                        ...
                        defaultValue={getFullHourName(props.startHourTue)}
                        onSelect={handleStartHourChangeTuesday}
                        style={{ borderColor: 'black', borderWidth: 1, height: 30, width: '40%', borderRadius: 5, padding: 5 }}
                    ...
                    <ModalDropdown
                        options={['06:00 AM', '07:00 AM', '08:00 AM', '09:00 AM', '10:00 AM', '11:00 AM', '12:00 AM', '01:00 PM', '02:00 PM', '03:00 PM', '04:00 PM', '05:00 PM', '06:00 PM', '07:00 PM', '08:00 PM', '09:00 PM', '10:00 PM']}
                        defaultValue={getFullHourName(props.endHourTue)}
                        onSelect={handleEndHourChangeTuesday}
                        style={{ borderColor: 'black', borderWidth: 1, height: 30, width: '40%', borderRadius: 5, padding: 5 }}
                        dropdownStyle={{ width: '40%', borderRadius: 5, }}
                        textStyle={styles.dropdownTitle}
                        dropdownTextStyle={styles.dropdownTitle}
            ...
            <View style={{ paddingTop: 12 }}>
                ...
                <View style={{ flexDirection: 'row', paddingTop: 10, justifyContent: 'space-between' }}>
                    <ModalDropdown
                        options={['06:00 AM', '07:00 AM', '08:00 AM', '09:00 AM', '10:00 AM', '11:00 AM', '12:00 AM', '01:00 PM', '02:00 PM', '03:00 PM', '04:00 PM', '05:00 PM', '06:00 PM', '07:00 PM', '08:00 PM', '09:00 PM', '10:00 PM']}
                        defaultValue={getFullHourName(props.breakStartHourTue)}
                        style={{ borderColor: 'black', borderWidth: 1, height: 30, width: '40%', borderRadius: 5, padding: 5 }}
                        dropdownStyle={{ width: '40%', borderRadius: 5, }}
                        textStyle={styles.dropdownTitle}
                        onSelect={handleBreakStartHourChangeTuesday}
                        dropdownTextStyle={styles.dropdownTitle}
                    />
                    <Text style={styles.dayText}>To</Text>
                    <ModalDropdown
                        options={['06:00 AM', '07:00 AM', '08:00 AM', '09:00 AM', '10:00 AM', '11:00 AM', '12:00 AM', '01:00 PM', '02:00 PM', '03:00 PM', '04:00 PM', '05:00 PM', '06:00 PM', '07:00 PM', '08:00 PM', '09:00 PM', '10:00 PM']}
                        defaultValue={getFullHourName(props.breakEndHourTue)}
                        style={{ borderColor: 'black', borderWidth: 1, height: 30, width: '40%', borderRadius: 5, padding: 5 }}
                        dropdownStyle={{ width: '40%', borderRadius: 5, }}
                        textStyle={styles.dropdownTitle}
                        onSelect={handleBreakEndHourChangeTuesday}
                        dropdownTextStyle={styles.dropdownTitle}
                    />
                </View>
            </View>

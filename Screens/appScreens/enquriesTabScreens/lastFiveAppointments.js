...
export default function LastFiveAppointments() {
    ...
    const fetchAppointmentRequests = async() => {
           ...
           // Call API to fetch last 5 appointment requests
      		var authToken = await AsyncStorage.getItem('@auth_token'); 
               ...
               fetch('https://lawyerback.trikaradev.xyz/api/lawyer-get-last-five-appointment-requests', {
                  method: "GET",
                  headers: {
               ...
               .then((json) => setTableData(json.latestFiveAppointments))
               .catch((error) => console.error('kk'+error))
        ...
        <View>
            <ScrollView>
                ...
                {appointmentRequests.length==0 &&
                  <Text style={{textAlign:'center', fontSize:20, marginTop:50}}>No appointments found</Text>
                }

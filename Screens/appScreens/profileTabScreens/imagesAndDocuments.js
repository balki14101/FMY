          ...
          <View style={styles.btnParentSection}>
             ...
             <View style={{ alignItems: 'center', paddingStart: 20, paddingEnd: 20 }}>
                ...
                <View>
                  ...
                  <View style={styles.formContainer1}>  
                    ...
                    {lawyer &&
                                       ...
                                       <Image 
                                          style={styles.profile} 
                                          source={{uri:'https://lawyerback.trikara.com/storage/' +lawyer.bar_cert_path}}/>
                 ...
                 <View style={styles.formContainer1}>  
                    ...
                    {lawyer &&
                                       ...
                                       <Image 
                                          style={styles.profile} 
                                          source={{uri:'https://lawyerback.trikara.com/storage/' +lawyer.aadhar_card_path}}/>
                ...
                <TouchableOpacity style={[styles.submitBtn, { width: '55%', marginTop: 10, marginBottom: 30 }]} 
                     onPress={submitStep3}>
                    <Text style={[styles.btnText, { color: 'white', fontSize:13 }]}>Save Images</Text>
                </TouchableOpacity>
